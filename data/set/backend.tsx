...
> Run admin/management tasks as one-off processes
    ...
    },
    {
        ...
        data: {
            ...
            answer: '
Authentication is the process of verifying the identity of a user or system, ensuring they are who they claim to be. This is typically done through credentials like passwords, biometric data, or digital certificates. On the other hand, authorization determines what actions an authenticated user or system is allowed to perform within a system or application. It controls access to resources based on the user's permissions, roles, or other criteria. Together, authentication and authorization form the backbone of access control mechanisms, safeguarding against unauthorized access and misuse of resources.
            ',
        }
    },
    {
        ...
        type: 'typing',
        data: {
            question: 'Common Design Parttern',
            answer: '
Design patterns are reusable solutions to common problems encountered in software design. Here are some popular design patterns:
...
4.  **Builder Pattern**: Separates the construction of a complex object from its representation, allowing the same construction process to create different representations.            ',
    ...
    },
    {
        ...
        type: 'typing',
        data: {
            question: 'What happens when you type a URL into your browser?',
            answer: '
When you type a website address into your browser and hit Enter, a series of fundamental actions take place in the background. First, the browser hunts down the numeric address linked to the website's name. Next, it establishes a connection with the server holding the site's data. Then, it sends a request to the server asking for the desired content. The server processes this request and prepares a response. Finally, the browser displays the received content for you to see. This sequence is essential knowledge for anyone working in IT, especially web development or networking.
',
        }
    },
    {
